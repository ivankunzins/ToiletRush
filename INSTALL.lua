...
for _,item in ipairs(files) do
    local old=item.parent:FindFirstChild(item.name);if old then old:Destroy() end
end
-- Legacy builder is no longer used; Main now uses UpperCourseV2.
local legacy=ServerScriptService:FindFirstChild("UpperCourseBuilder");if legacy then legacy:Destroy() end
...
print("[ToiletRush] ВАЖНО: для Robux-магазина создай 3 Developer Products и вставь их IDs в Config.RobuxShop.")
